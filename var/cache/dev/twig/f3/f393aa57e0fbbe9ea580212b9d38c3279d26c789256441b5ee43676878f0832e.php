...
class __TwigTemplate_ff8282e4d671db5a5c97d351fda02ee2b2a42930286eda17943d53391e7f2cd0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-body\">
        ...
        <div lcass=\"text-primary\" style=\"font-size: 2rem; font-weight: bold\">
            ";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 10, $this->source); })()), "formattedPrice", [], "any", false, false, false, 10), "html", null, true);
        echo " €
        </div>
    </div>
</div>
