...
class __TwigTemplate_49e3fbb5fc23cada16a3ce62aa99d9d54cb4691939ca86822276e39408068d60 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connectés en tant que {{ app.user.username }}, <a href=\"{{ path('logout') }}\">Se déconnecter</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\workspace\\homeaway\\templates\\security\\login.html.twig");
    }
}
